...
if ! git clone --depth=1 -b android-13.0.0_r13 https://android.googlesource.com/platform/prebuilts/clang/host/linux-x86.git ${TC_DIR}; then
...
if ! git clone --depth=1 -b lineage-18.1 https://github.com/me-zjc/android_prebuilts_gcc_linux-x86_aarch64_aarch64-linux-android-4.9.git ${GCC_64_DIR}; then
echo "Cloning failed! Aborting..."
exit 1
fi
fi
...
if ! git clone --depth=1 -b lineage-18.1 https://github.com/me-zjc/android_prebuilts_gcc_linux-x86_arm_arm-linux-androideabi-4.9.git ${GCC_32_DIR}; then
echo "Cloning failed! Aborting..."
exit 1
fi
fi
